...
class State extends VizPanel implements TouchEnabled {
    ...
    State(String _id, String _name, float xc, float yc, float len,
	...
	v.setStyle(MyColorEnum.BLACK, MyColorEnum.DARK_BLUE,
		MyColorEnum.DARK_WHITE, 255, 255, 4);
	v.setStyleSelected(MyColorEnum.BLACK, MyColorEnum.LIGHT_BLUE,
		MyColorEnum.WHITE, 255, 255, 4);
	v.setText(acName);
