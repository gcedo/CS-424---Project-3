...
public class FilterToolbox extends VizPanel implements TouchEnabled, EventSubscriber {
  ...
  public void setup() {
    ...
    alcoholList.setup(LIGHT_GRAY, DARK_GRAY, N_ROWS, getAlcohol(), false, SelectionMode.SINGLE);
    ...
    speedList.setup(LIGHT_GRAY, DARK_GRAY, N_ROWS, getSpeeds(), false, SelectionMode.SINGLE);
    ...
    ageList.setup(LIGHT_GRAY, DARK_GRAY, N_ROWS, getAge(), false, SelectionMode.SINGLE);
