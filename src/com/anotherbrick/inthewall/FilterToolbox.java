...
public class FilterToolbox extends VizPanel implements TouchEnabled {
	...
	alcoholList = new VizList(SECOND_COL_X0, FIRST_ROW_Y0 + BUTTON_H,
		LIST_W, LIST_H, this);
	alcoholList.setup(LIGHT_GRAY, DARK_GRAY, N_ROWS, getMonths(), false,
		SelectionMode.MULTIPLE);
	...
	vehicleList = new VizList(SECOND_COL_X0, SECOND_ROW_Y0 + BUTTON_H,
		LIST_W, LIST_H, this);
	vehicleList.setup(LIGHT_GRAY, DARK_GRAY, N_ROWS, getVehicles(), false,
		SelectionMode.MULTIPLE);
	...
	// Hour
	hourList = new VizList(SECOND_COL_X0, FOURTH_ROW_Y0 + BUTTON_H, LIST_W,
		LIST_H, this);
	...
	sexList = new VizList(FIRST_COL_X0, FIFTH_ROW_Y0 + BUTTON_H, LIST_W,
		LIST_H, this);
	sexList.setup(LIGHT_GRAY, DARK_GRAY, N_ROWS, getSex(), false,
		SelectionMode.MULTIPLE);
	...
	// Light Condition
	lcList = new VizList(SECOND_COL_X0, FIFTH_ROW_Y0 + BUTTON_H, LIST_W,
		LIST_H, this);
	...
	for (Map.Entry<VizButton, VizList> entry : listsAndButtons.entrySet()) {
	    entry.getKey().setStyle(MEDIUM_GRAY, WHITE, LIGHT_GRAY, 255, 255,
		    14);
	    entry.getKey().setStyleDisabled(MEDIUM_GRAY, WHITE, LIGHT_GRAY,
		    255, 255, 14);
