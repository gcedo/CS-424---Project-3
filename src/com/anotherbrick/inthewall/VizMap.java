...
public class VizMap extends VizPanel implements TouchEnabled, EventSubscriber {
    ...
    private StateInfo currentState = new StateInfo(17, "Illionis",
	    new Location(40.633125f, -89.398528f));
     ...
     * - 537 * 0.5 / map.sc && a.getY0() < -map.ty + 384 * 0.5 / map.sc &&
     * a.getY0() > -map.ty - 384*0.5/map.sc) { if (a.getX0() < lon_right &&
     * a.getX0() > lon_left) { //&& a.getY0() < lat_top && a.getY0() > lat_bot)
     * { a.draw(); System.out.println("drawn!"); } else {
     * System.out./("didn't!"); } } //System
